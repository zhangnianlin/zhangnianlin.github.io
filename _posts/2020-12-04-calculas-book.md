...
本文准备回答以下几个问题：
1. 本书的是如何对微积分的知识进行梳理的？
2. 阅读本书时，最好带着什么样的问题进行阅读？

## 问题

书籍本身致力于解决的问题：
1. 在坐标系当中，各个函数的曲线。这个是基本的高中数学问题。
2. 极限的现实意义，以及其可以解决的问题是什么？
3. 在极限的基础上，导数是什么？有什么样的作用？
4. 探讨各种函数的极限与导数的情况，以及其相关的现实意义。（譬如说，指数函数可以推断半衰期）
